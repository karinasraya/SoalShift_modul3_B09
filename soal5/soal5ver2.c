...
int main()
{
    ...
    int err;
        ...
        err=pthread_create(&(tid[1]),NULL,&bau,NULL); //membuat thread
		if(err!=0) //cek error
		{
			printf("\n can't create thread : [%s]",strerror(err));
		}
        ...
        err=pthread_create(&(tid[2]),NULL,&regen,NULL); //membuat thread
		if(err!=0) //cek error
		{
			printf("\n can't create thread : [%s]",strerror(err));
		}
        ...
        err=pthread_create(&(tid[3]),NULL,&mandichecker,NULL); //membuat thread
		if(err!=0) //cek error
		{
			printf("\n can't create thread : [%s]",strerror(err));
		}
        ...
        err=pthread_create(&(tid[4]),NULL,&cene1,NULL); //membuat thread
		if(err!=0) //cek error
		{
			printf("\n can't create thread : [%s]",strerror(err));
		}
        ...
        err=pthread_create(&(tid[5]),NULL,&cene3,NULL); //membuat thread
		if(err!=0) //cek error
		{
			printf("\n can't create thread : [%s]",strerror(err));
		}
